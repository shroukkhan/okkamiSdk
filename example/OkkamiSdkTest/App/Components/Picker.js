...
export default class ModalPicker extends Component {
    ...
    return (
      <View style={[styles.overlayStyle, this.props.overlayStyle]} key={'modalPicker' + (componentIndex++)}>
        <View style={styles.optionContainer}>
          <ScrollView keyboardShouldPersistTaps style={{height: 100}}>
  ...
  render () {
    const dp = (
      <Modal transparent ref='modal' visible={this.state.modalVisible} onRequestClose={this.close} animationType={this.state.animationType}>
